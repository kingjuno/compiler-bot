...
class Compile(commands.Cog):
    ...
    async def execute(self,ctx,*,arg):
        ...
        f.close()
        try:
            res=subprocess.check_output("python exec.py < in.txt", shell=True)
        except:
